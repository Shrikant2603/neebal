...
public class LegoSetCompetition2 {
	...
	outer: do {
	    ...
	    int d = 1;
	    if (player1 != null) {
		player1 = new CompetitionLog(1, player1.getCompleteSets(),
			legoname1 + " " + legoname2 + " " + legoname3, player1.getPiecesBuilt());
		player2 = new CompetitionLog(2, player2.getCompleteSets(),
			legoname1 + " " + legoname2 + " " + legoname3, player2.getPiecesBuilt());
	    } else {
		...
		if (player1.getPiecesBuilt() - number1 - number2 >= number2)
		    player1.setCompleteSets(
			    player1.getCompleteSets() + " " + legoname1 + " " + legoname2 + " " + legoname3);
		player1.setIncompleteSets("");

		if (player2.getPiecesBuilt() - number1 - number2 >= number3) {
		    player2.setCompleteSets(
			    player2.getCompleteSets() + " " + legoname1 + " " + legoname2 + " " + legoname3);
